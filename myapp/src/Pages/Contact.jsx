...
//         >
//           I am currently specializing in MERN development.
//           <br />
//           Feel free to drop a message for any suggestion,
//           <br />
...
//         >
//           <Text fontWeight={"bold"} fontSize={"22px"} color={"#25cefd"}>
//             {" "}
//             📞 Call
//           </Text>
//           +91 7999649443
...
//           borderRadius={"20px"}
//           padding={"10px 0 10px 0"}
//           boxShadow="rgb(235, 214, 214) 0px 10px 20px, rgba(159, 146, 146, 0.982) 0px 6px 6px"
//           id="contact-email"
//           _hover={{ cursor: "pointer" }}
//         >
//           <Text fontWeight={"bold"} fontSize={"22px"} color={"#25cefd"}>
...
//           color={"white"}
//           padding={"10px 0 10px 0"}
//           boxShadow="rgb(61, 164, 193) 0px 10px 20px, rgba(60, 138, 131, 0.982) 0px 6px 6px"
//           _hover={{ cursor: "pointer" }}
//         >
//           <Text fontWeight={"bold"} fontSize={"22px"} color={"#25cefd"}>
//             🌏 Address
//           </Text>
//           Inore,Madhya Pradesh
//         </Box>
//       </Flex>
//       <Box>
//         <Center>
...
//               <Link href="https://github.com/Jitugandhare" target="_blank">
//                 <Box
//                   border="3px solid white"
//                   padding={4}
//                   borderRadius="50%"
...
//         alignContent={"center"}
//       >
//         <Text fontSize={"20px"}>Made by Jitu Gandhare 💫 ❤️</Text>
//       </Box>
//     </Box>
//   );
// }
